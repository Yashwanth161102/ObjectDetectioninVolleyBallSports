...
pather="/Users/yashwanthponugoti/Documents/major/uploads/original.jpg"
# Parse command-line arguments
parser = argparse.ArgumentParser(description='YOLOv8 Image/Video Processing')
parser.add_argument('--model',default="/Users/yashwanthponugoti/Documents/major/Player_detection/runs/detect/yV8_medium/weights/best.pt" , help="Path to model's weights")
parser.add_argument('--input_path',default=pather, help='Path to the input image or video file')
parser.add_argument('--output_path', default='/Users/yashwanthponugoti/Documents/major/static/images/original.jpg', help='Output directory path (for images) or output file path (for videos)')
