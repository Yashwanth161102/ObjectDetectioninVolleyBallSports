...
if output_path == "":  #
    os.makedirs('/Users/yashwanthponugoti/Documents/major/static/videos', exist_ok=True)
    if input_type == 'video':
        output_path = os.path.join(
            '/Users/yashwanthponugoti/Documents/major/static/videos',  basename)
    else:
        output_path = os.path.join(
            '/Users/yashwanthponugoti/Documents/major/static/videos',  basename.split('.')[0] + '.jpg')
