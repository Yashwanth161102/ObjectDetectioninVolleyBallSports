...
if output_path == "":  #
    os.makedirs('/Users/yashwanthponugoti/Documents/major/static/images', exist_ok=True)
    if input_type == 'video':
        output_path = os.path.join(
            '/Users/yashwanthponugoti/Documents/major/static/images',  basename)
    else:
        output_path = os.path.join(
            '/Users/yashwanthponugoti/Documents/major/static/images',  basename.split('.')[0] + '.jpg')
...
### Model Selection ###
model = custom(path_or_model='/Users/yashwanthponugoti/Documents/major/ball_track/yV7-tiny/weights/best.pt')
model.conf = conf
